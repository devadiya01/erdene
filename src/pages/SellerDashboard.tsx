  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><span className="font-medium">Үнэ:</span> ${product.price.toFixed(2)}</p>
                <p><span className="font-medium">Тоо хэмжээ:</span> {product.quantity} {product.unit}</p>
                <p><span className="font-medium">Ангилал:</span> {product.category}</p>
        ...
        {products.length === 0 && (
          <p className="text-gray-500 text-center py-8">Одоогоор бүтээгдэхүүн байхгүй байна!</p>
        )}
      </div>

      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4">Админы тохируулсан харилцагчид</h2>
        ...
        {matches.length === 0 && (
          <p className="text-gray-500 text-center py-8">Одоогоор тохируулсан харилцагч байхгүй байна!</p>
        )}
      </div>
    </div>
  );
